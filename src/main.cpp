...
// SX126x pin configuration !!! CHANGE HERE !!!
int PIN_LORA_RESET = PC10;	 // LORA RESET
...
void setup()
{
  ...
  // Can also be  SX1261_CHIP or SX1268_CHIP 
  ...
  // Can be -1 of not used (both or one)
